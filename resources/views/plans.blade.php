        ...
        <div
            ...
            <div class="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-base text-slate-700 leading-tight">For new makers who want to fine-tune and test
                        an
                        idea.</p>
                    <p class="mt-8">
                    ...
                    </p><a href="{{ route('checkout', ['plan' => 'price_1QQ94qP2wod00dHxHUXT1KiC']) }}"
                ...
                <div class="pt-6 pb-8 px-6">
                    ...
                    <ul role="list" class="mt-4 space-y-3">
                        <li class="flex space-x-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5 text-green-400"
            ...
            <div class="border border-slate-200 rounded-lg shadow-sm divide-y divide-slate-200">
                <div class="p-6">
                    ...
                    <p class="mt-2 text-base text-slate-700 leading-tight">For productive shippers who want to work
                        more
                        efficiently.</p>
                    <p class="mt-8">
